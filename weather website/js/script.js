...
const citiesData = [
    ...
    { "latitude": 48.208, "longitude": 16.373, "city": "Vienna", "country": "Austria" },
...
/// Fetch 7-day weather data from Open-Meteo API
...
// Display the 7-day weather forecast with images
function displayWeatherData(data) {
    const forecastData = document.getElementById("forecastData");
    forecastData.innerHTML = ""; // Clear previous forecast

    data.daily.time.forEach((day, index) => {
        const maxTemp = data.daily.temperature_2m_max[index];
        const minTemp = data.daily.temperature_2m_min[index];
        const weatherCode = data.daily.weathercode[index]; // Weather condition code

        // Determine the image based on weather condition code
        let weatherImage = "";
        switch (weatherCode) {
            case 0: // Clear sky
            ...
            case 2: // Partly cloudy
                weatherImage = "/images/pcloudy.png";
                break;
            case 3: // Overcast
                weatherImage = "/images/cloudline.png";
                break;
            case 45: // Fog
            ...
            case 95: // Thunderstorm
                ...
                break;
            default:
                weatherImage = "/images/humid.png"; // Default image for unknown weather
        }
        ...
        forecastDay.innerHTML = `
            ...
            <img src="${weatherImage}" alt="Weather image" class="weather-icon">
            <p>Max: ${maxTemp}°C</p>
            <p>Min: ${minTemp}°C</p>
        `;
...
// Call this function after the page loads to initialize the city dropdown
